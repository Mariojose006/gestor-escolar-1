...
public class AdmNovaDisciplina extends javax.swing.JFrame {
    ...
    /**
     * Creates new form AdmNovaDisciplina
     */
    public AdmNovaDisciplina() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdmNovaDisciplina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdmNovaDisciplina().setVisible(true);
            }
        });
    }
