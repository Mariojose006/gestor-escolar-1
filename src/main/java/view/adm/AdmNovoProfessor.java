 ...
 * @author adria
 */
public class AdmNovoProfessor extends javax.swing.JFrame {

    /**
     * Creates new form AdmNovoProfessor
     */
    AdmProfTableModel tmd = new AdmProfTableModel();
    
    public AdmNovoProfessor() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdmNovoProfessor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdmNovoProfessor().setVisible(true);
            }
        });
    }
